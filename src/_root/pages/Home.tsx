  ...
  return (
    <section className='w-full'>
      ...
      <div className=' flex flex-col justify-center items-center mt-[100px]'>
        ...
        <div className='flex flex-col md:flex-row w-full items-center justify-around px-40 py-12' data-aos="zoom-in-up">
          <div className='flex flex-col items-center '>
            <img src="/public/images/f4.jpg" alt="f4" className='size-40 mb-9 transition ease-in-out hover:-translate-y-4 delay-50' />
            <p className='text-xl font-semibold leading-8  w-3/4  text-[#202124] font-jost'>Register  an account to start</p>

          </div>
          <div className='flex flex-col items-center '>
              <img src="/public/images/f5.jpg" alt="f5" className='size-40 mb-9 transition ease-in-out hover:-translate-y-4 delay-50'/>
              <p className='text-xl font-semibold leading-8  w-3/4  text-[#202124] font-jost'>Explore over thousands of resumes</p>
          </div>
          <div className='flex flex-col items-center '>
            <img src="/public/images/f5.jpg" alt="f6" className='size-40 mb-9  transition ease-in-out hover:-translate-y-4 delay-50' />
