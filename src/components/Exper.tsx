    ...
    <section>
        ...
        <div className='h-[600px] lg:h-[900px]  w-full '>
            <div className='bg-[url("/images/bg-slider4.jpg")] w-full h-full object-cover overflow-hidden'>
                ...
                <div className="flex flex-col space-y-10 items-center justify-center pt-[150px]">
                    <h1 className='text-white text-3xl lg:text-5xl font-bold p-7 mx-auto'>The Easiest Way to Get Your New Job</h1>
                    <SearchForm  />
                    <p className='text-white text-lg justify-center items-center lg:text-xl font-medium leading-9'>Popular Searches : Designer Developer Web IOS PHP Senior Engineer</p>
